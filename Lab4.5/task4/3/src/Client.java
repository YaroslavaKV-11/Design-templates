...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        Triangle.Memento maxSquareMemento = findMaxSquareMemento(history);
        maxSquareMemento.restore();
    ...
    private static Triangle.Memento findMaxSquareMemento(List<Triangle.Memento> history) {
