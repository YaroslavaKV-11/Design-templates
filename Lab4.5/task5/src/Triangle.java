public class Triangle {
    ...
    public Memento saveState() {
        return new StateMemento(a, b, c);
    }

    public void restoreState(Memento memento) {
        StateMemento stateMemento = (StateMemento) memento;

        this.a = stateMemento.a;
        this.b = stateMemento.b;
        this.c = stateMemento.c;
    }

    public float square(Memento memento) {
        StateMemento stateMemento = (StateMemento) memento;

        return stateMemento.square();
    }
    ...
    private static class StateMemento implements Memento {
        ...
        public StateMemento(float a, float b, float c) {
            this.a = a;
            this.b = b;
            this.c = c;
        }
